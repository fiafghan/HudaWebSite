        ...
        <main className="page-theme max-w-7xl mx-auto px-4 md:px-6 py-8">
          ...
          <div className="grid gap-6">
            <section id="opening" className="content-section">
              ...
              <Link to="/docs/opening" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Opening docs</Link>
            </section>
            ...
            <section id="cleaning" className="content-section">
              ...
              <Link to="/docs/cleaning" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Cleaning docs</Link>
            </section>
            ...
            <section id="transformation" className="content-section">
              ...
              <Link to="/docs/transformation" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Transformation docs</Link>
            </section>
            ...
            <section id="validation" className="content-section">
              ...
              <Link to="/docs/validation-quality" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Validation & Quality docs</Link>
            </section>
            ...
            <section id="geospatial" className="content-section">
              ...
              <Link to="/docs/geospatial" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Geospatial docs</Link>
            </section>
            ...
            <section id="analysis" className="content-section">
              ...
              <Link to="/docs/analysis" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Analysis docs</Link>
            </section>
            ...
            <section id="visualization" className="content-section">
              ...
              <Link to="/docs/visualization" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Visualization docs</Link>
            </section>
            ...
            <section id="automation" className="content-section">
              ...
              <Link to="/docs/automation" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Automation & Workflows docs</Link>
            </section>
            ...
            <section id="interoperability" className="content-section">
              ...
              <Link to="/docs/interoperability" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Interoperability docs</Link>
            </section>
            ...
            <section id="ml4humanitarian" className="content-section">
              ...
              <Link to="/docs/ml4humanitarian" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full ML for Humanitarian Data docs</Link>
            </section>
            ...
            <section id="document-processing" className="content-section">
              ...
              <Link to="/docs/document-processing" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Text & Document Processing docs</Link>
            </section>
            ...
            <section id="humanitarian-metrics" className="content-section">
              ...
              <Link to="/docs/humanitarian-metrics" className="text-sm text-blue-500 hover:text-indigo-900 underline">Open full Humanitarian Metrics docs</Link>
            </section>
          </div>
        </main>
        <Footer />
